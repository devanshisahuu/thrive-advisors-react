...
import './footer131.css'

const Footer131 = (props) => {
  return (
    <footer className="footer131-container thq-section-padding">
      <div className="footer131-column2">
        <strong className="footer131-column2-title thq-body-large">
          {props.column2Title}
        </strong>
        <div className="footer131-footer-links">
      ...
      <div className="footer131-max-width thq-section-max-width">
        <div className="thq-divider-horizontal"></div>
        <div className="footer131-content">
          <img
            alt={props.logoAlt}
            src={props.logoSrc}
            className="footer131-image1"
          />
          <div className="footer131-links thq-grid-5">
            <div className="footer131-column1">
              <strong className="thq-body-large footer131-column1-title">
                {props.column1Title}
              </strong>
              <div className="footer131-footer-links1">
            ...
            <div className="footer131-column3">
              <strong className="footer131-column3-title thq-body-large">
                {props.column3Title}
              </strong>
              <div className="footer131-footer-links2">
        ...
        <div className="thq-divider-horizontal"></div>
        <div className="footer131-credits">
          <div className="footer131-row">
            <div className="footer131-credits1">
          ...
          <div className="footer131-social-links">
            <svg
          ...
          <span className="footer131-content3 thq-body-small">
            {props.copyright}
          </span>
        </div>
      </div>
...
Footer131.defaultProps = {
  link22: 'Careers',
  link6: 'Investment Management',
  privacyLink: '/privacy-policy',
  link17: 'LinkedIn',
  column5Title: 'Follow Us',
  column2Title: 'About Us',
  link20: 'Phone',
  link13: 'Terms of Service',
  link10: 'FAQs',
  logoSrc: 'https://presentation-website-assets.teleporthq.io/logos/logo.png',
  column4Title: 'Contact Us',
  termsLink: '/terms-of-service',
  link16: 'Twitter',
  link8: 'Financial Security Solutions',
  cookiesLink: '/cookies-policy',
  link1: 'Home',
  link7: 'Retirement Planning',
  link5: 'Blog',
  link18: 'Instagram',
