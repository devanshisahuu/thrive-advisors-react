        ...
        <div className="footer8-content">
          <div className="footer8-newsletter">
            ...
            <span className="thq-body-small">
              <span className="footer8-text2">Contact</span>
              <br className="footer8-text3"></br>
              <span>+</span>
              <span className="footer8-text5">1234567890</span>
              <br></br>
              <span className="footer8-text7">info@contact.support</span>
              <br></br>
            </span>
