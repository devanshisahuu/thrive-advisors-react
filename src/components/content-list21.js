...
const ContentList21 = (props) => {
  return (
    <div className="content-list21-container thq-section-padding">
      <div className="content-list21-max-width thq-section-max-width thq-flex-column">
        <div className="content-list21-content thq-flex-column">
          <ul>
            <li className="content-list21-li list-item thq-flex-column">
              <h2 className="content-list21-heading1 thq-heading-2">
                {props.heading1}
              </h2>
              <ul className="content-list21-ul1 thq-flex-column">
        ...
        <div className="content-list21-content1 thq-flex-column">
          <ul></ul>
        </div>
      </div>
    </div>
