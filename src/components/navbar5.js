      ...
      <header data-thq="thq-navbar" className="navbar5-navbar-interactive">
        ...
        <div data-thq="thq-navbar-nav" className="navbar5-desktop-menu">
          <nav className="navbar5-links">
            <span className="navbar5-link2 thq-body-small thq-link">
              {props.link1}
            </span>
            <span className="navbar5-link3 thq-body-small thq-link">
              {props.link2}
            </span>
            <span className="navbar5-link4 thq-body-small thq-link">
              {props.link3}
            </span>
            <div className="navbar5-container1">
              {link5DropdownVisible && (
                <div className="navbar5-container2 thq-box-shadow">
        ...
        <div data-thq="thq-mobile-menu" className="navbar5-mobile-menu">
          ...
          <div className="navbar5-icon-group">
            ...
            <svg
              ...
              className="navbar5-icon10 thq-icon-x-small"
            >
            ...
            <svg
              ...
              className="navbar5-icon12 thq-icon-x-small"
            >
