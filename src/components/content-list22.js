...
const ContentList22 = (props) => {
  return (
    <div className="content-list22-container thq-section-padding">
      <div className="content-list22-max-width thq-section-max-width thq-flex-column">
        <div className="content-list22-content thq-flex-column">
          <ul>
            <li className="content-list22-li list-item thq-flex-column">
              <h2 className="content-list22-heading1 thq-heading-2">
                {props.heading1}
              </h2>
              <p>{props.content1}</p>
            </li>
        ...
        <div className="content-list22-content1 thq-body-small content-list22-content1 thq-flex-column">
          <ul>
            <li className="content-list22-li1 list-item thq-flex-column">
              <h2 className="content-list22-heading7 thq-heading-2">
                {props.heading7}
              </h2>
              <p className="content-list22-content7 thq-body-small">
                {props.content7}
              </p>
            </li>
          </ul>
